...
import com.example.foodrunners.activity.CartActivity
...
class MenuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        sharedPreferences =
            activity?.getSharedPreferences(getString(R.string.pref_file_name), Context.MODE_PRIVATE) as SharedPreferences
